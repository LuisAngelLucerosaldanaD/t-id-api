...
func NewTraceability(id int64, action string, description string, userId string) *Traceability {
	return &Traceability{
		ID:          id,
		Action:      action,
...
func NewCreateTraceability(action string, description string, userId string) *Traceability {
	return &Traceability{
		Action:      action,
		Description: description,
		UserId:      userId,
